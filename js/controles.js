...
function manejarEnvioFormulario(event, tableBody) {
    ...
    const numeroArete = document.getElementById("animal").value;
...
// guardar la tabla enn localStorage
...
function cargarTabla(tableBody) {
    ...
    // Si no hay datos en localStorage, inicializar con datos predeterminados
    if (!localStorage.getItem("controlesInicializados") || !registros) {
        registros = [
        ...
        localStorage.setItem("controles", JSON.stringify(registros));
        localStorage.setItem("controlesInicializados", "true");
    }
...
function cargarAnimales() {
    ...
    animales.forEach(animal => {
        ...
        option.value = animal.numeroArete;
